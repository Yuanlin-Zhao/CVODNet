...
def make_parser():
    ...
    parser.add_argument("--tsize", default=640
...
def main(exp, args):
    ...
    val_loader, val_loader_ir = exp.get_eval_loader(batch_size=lframe+gframe,data_num_workers=2)
    trainer = Trainer(exp, args, val_loader, val_loader_ir,val=False)
    trainer.train()
