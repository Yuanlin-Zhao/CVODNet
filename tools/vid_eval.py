...
def make_parser():
    ...
    parser.add_argument("-c", "--ckpt", default=r'D:\aa-duomotaishipinjiance\YOLOV-master\tools\V++_outputs\v++_base_decoupleReg\best_ckpt.pth', type=str, help="checkpoint file")
    parser.add_argument(
        '-data_dir',
        default='',
        type=str,
