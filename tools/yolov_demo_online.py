...
def make_parser():
    ...
    parser.add_argument("-n", "--name", type=str, default='', help="model name")

    parser.add_argument(
        "--path", default=r"D:\aa-duomotaishipinjiance\YOLOV-master\new.mp4", help="path to images or video"
    )
    ...
    parser.add_argument(
        "-f",
        "--exp_file",
        default=r'D:\aa-duomotaishipinjiance\YOLOV-master\exps\yolov++\v++_base_decoupleReg.py',
        type=str,
        help="pls input your expriment description file",
    )
    parser.add_argument("-c", "--ckpt", default=r'D:\aa-duomotaishipinjiance\YOLOV-master\tools\V++_outputs\v++_base_decoupleReg\best_ckpt.pth', type=str, help="ckpt for eval")
    parser.add_argument(
        "--device",
        default="gpu",
        type=str,
    ...
    parser.add_argument("--tsize", default=448, type=int, help="test img size")
    parser.add_argument(
        "--fp16",
        dest="fp16",
        default=True,
    ...
    parser.add_argument('--gframe', default=2, help='global frame num')
