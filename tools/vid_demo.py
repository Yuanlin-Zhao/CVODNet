...
def make_parser():
    ...
    parser.add_argument(
        "--path", default=r"D:\aa-duomotaishipinjiance\YOLOV-master\5.mp4", help="path to images or video"
    )
    ...
    parser.add_argument('--output_dir', default=r'D:\aa-duomotaishipinjiance\YOLOV-master\output',
