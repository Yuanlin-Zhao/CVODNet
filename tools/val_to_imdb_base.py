...
def make_parser():
    ...
    parser.add_argument(
        "--path", default=r'D:\aa-duomotaishipinjiance\YOLOV-master\val_seq.npy', help="path to images or video"
    )
...
def imageflow_demo(predictor, val_path, args,exp):
    ...
    dataset_val = vid.VIDDataset(file_path=r'D:\aa-duomotaishipinjiance\YOLOV-master\val_seq.npy',
