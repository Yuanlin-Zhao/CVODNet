...
class VIDEvaluator:
    ...
    def __init__(
            self, dataloader, dataloader_ir, img_size, confthre, nmsthre,
        ...
        self.dataloader_ir = dataloader_ir
        ...
        self.vid_to_coco = {
            ...
            'annotations': [],
            'categories': [{"supercategorie": "", "id": 0, "name": "ship"},],
            'images': [],
            'licenses': []
        }
    ...
    def evaluate(
        ...
        for cur_iter, (imgs, _, info_imgs, label, path, time_embedding) in enumerate(
            ...
            with torch.no_grad():
                ...
                outputs, ori_res = model(imgs, imgs,
                                         lframe=self.lframe,
                                         gframe = self.gframe)
